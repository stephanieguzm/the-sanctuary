...
describe('Room', () => {
  ...
  it('should have a room number', () => {
    expect(room2).to.have.a.property('number');
    expect(room1.number).to.equal(11);
    expect(room2.number).to.equal(15);
  });

  it('should have a room type', () => {
    expect(room2).to.have.a.property('roomType');
